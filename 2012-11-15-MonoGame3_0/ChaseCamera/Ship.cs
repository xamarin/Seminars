...
namespace ChaseCameraSample
{
    class Ship
    {
        ...
        bool TouchLeft()
        {
			...
			var screenTouched = (touchState.Count > 0) && touchState[0].Position.X <= graphicsDevice.Viewport.Width / 3;

			return (mouseState.LeftButton == ButtonState.Pressed &&
				mouseState.X <= graphicsDevice.Viewport.Width / 3) || screenTouched;
        }
        ...
        bool TouchRight()
        {
			...
			TouchCollection touchState = TouchPanel.GetState();
			var screenTouched = (touchState.Count > 0) && touchState[0].Position.X >= 2 * graphicsDevice.Viewport.Width / 3;

            return (mouseState.LeftButton == ButtonState.Pressed &&
				mouseState.X >= 2 * graphicsDevice.Viewport.Width / 3) || screenTouched;
        }
        ...
        bool TouchDown()
        {
			...
			TouchCollection touchState = TouchPanel.GetState();
			var screenTouched = (touchState.Count > 0) && touchState[0].Position.Y <= graphicsDevice.Viewport.Height / 3;

            return (mouseState.LeftButton == ButtonState.Pressed &&
				mouseState.Y <= graphicsDevice.Viewport.Height / 3) || screenTouched;
        }
        ...
        bool TouchUp()
        {
			...
			TouchCollection touchState = TouchPanel.GetState();
			var screenTouched = (touchState.Count > 0) && touchState[0].Position.Y >= 2 * graphicsDevice.Viewport.Height / 3;

            return (mouseState.LeftButton == ButtonState.Pressed &&
				mouseState.Y >= 2 * graphicsDevice.Viewport.Height / 3) || screenTouched;
        }
        ...
        public void Update(GameTime gameTime)
        {
            ...
            MouseState mouseState = Mouse.GetState();
			var screenTouched = TouchPanel.GetState().Count > 0;
			...
			if (keyboardState.IsKeyDown(Keys.Space) || mouseState.LeftButton == ButtonState.Pressed || screenTouched)
                thrustAmount = 1.0f;
