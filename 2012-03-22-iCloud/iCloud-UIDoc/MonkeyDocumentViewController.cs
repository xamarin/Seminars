...
namespace Cloud
{
	public class MonkeyDocumentViewController : UIViewController
	{
		...
		{	
			...
			saveButton.Frame = new RectangleF(10,10,160,50);
			saveButton.SetTitle("UpdateChangeCount", UIControlState.Normal);
			saveButton.SetTitleColor(UIColor.Gray, UIControlState.Disabled);
			saveButton.Enabled = false;
			
			alertText = new UITextView(new RectangleF(175, 10, 140, 50));
			alertText.TextColor = UIColor.Red;
			alertText.Editable = false;

			docText = new UITextView(new RectangleF(10, 70, 300, 150));
